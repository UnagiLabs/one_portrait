...
- Walrus 公開エンドポイント (Publisher / Aggregator)
...
# Sui Testnet へ Publish (PACKAGE_ID / AdminCap ID を控える)
sui client publish packages/move
...
# apps/web/.env.local
SUI_NETWORK=testnet
PACKAGE_ID=<sui publish で取得>
WALRUS_PUBLISHER=https://publisher.walrus-testnet.walrus.space
WALRUS_AGGREGATOR=https://aggregator.walrus-testnet.walrus.space
ENOKI_API_KEY=<Enoki ダッシュボードから>

# Cloudflare Secrets Store
ADMIN_SUI_PRIVATE_KEY=<finalize 用 AdminCap 保有鍵>
```
...
| 優先度 | 項目 |
| :---: | :--- |
| **P0** | zkLogin / `submit_photo` + Kakera 即時 mint / 進捗カウンター購読 / ブラウザ分散トリガーによる `/api/finalize` 発火 / Generator greedy 合成 → Walrus 保存 → `finalize` Tx / リビール演出 + 自分のマス逆引きハイライト |
| **P1** | `/gallery`（Master 未完ユニット含む）/ ハンガリアン法へアップグレード |
...
| 項目 | |
| :--- | :--- |
| **Event** | Sui x ONE Samurai — Tokyo Builders' Arena (Apr 2026) |
| **Hosts** | Sui Foundation × ONE Championship |
| **Theme** | ONE Championship と日本のファンをつなぐ新たな方法 / アスリートとファンの距離を縮める仕組み |
| **Build Period** | 2026-04-13 (Mon) — 2026-04-25 (Sat) 12:00 |
| **Final Selection** | 2026-04-26 (Sun) 21:00 |
| **Demo Day** | 2026-04-28 (Tue) 18:30 — 22:30 (Tokyo, 対面) |
| **ONE Samurai Event** | 2026-04-29 (Wed・祝) @ 有明アリーナ |
| **Prizes** | 🥇 $3,000 / 🥈 $1,500 / 🥉 $750 + 入賞者全員に **ONE Samurai @ 有明アリーナ 招待チケット** |
| **Team** | 最大2名 — `<!-- TEAM:TODO -->` |
| **Official** | https://luma.com/suionesamurai |
