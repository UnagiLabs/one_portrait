...
| :--- | :--- | :--- | :--- |
| 自動 lane | `corepack pnpm run test:e2e:readiness` | `#23` の gallery 導線、`#24` の gallery connect CTA、`#25` の degraded UX を stub E2E でまとめて確認する | real Google login、real Walrus PUT、real Sponsored submit、real Kakera 確認 |
| 手動 lane | `corepack pnpm run dev:smoke` | `#22` の実送信主線を real env で 1 回通し、証跡 3 点を残す | UI 文言の広い回帰、stub E2E の代替 |
...
6. 失敗した場合は、この runbook の「最新確認結果」に到達地点を書きます。
